...
void* execute_calendar_maintenance(){
	if(((button_map>>UP_BUTTON_POSITION)&PRESSED)!=0 && (((button_map>>DOWN_BUTTON_POSITION)&PRESSED)==0) && (((button_map>>ENTER_BUTTON_POSITION)&PRESSED)==0))
		inc_calendar_flds(1);
	else if(((button_map>>DOWN_BUTTON_POSITION)&PRESSED)!=0 && ((button_map>>UP_BUTTON_POSITION)&PRESSED)==0 && ((button_map>>ENTER_BUTTON_POSITION)&PRESSED)==0)
		inc_calendar_flds(-1);
